    ...
    <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light">
        <div class="container">
            ...
            <div class="navbar-collapse collapse" id="navbar_global">
                            ...
                            <div class="dropdown-menu-inner">
                                <a href="https://demos.creative-tim.com/argon-design-system/docs/getting-started/overview.html" class="media d-flex align-items-center">
                                    ...
                                    <div class="media-body ml-3">
                                        <h6 class="heading text-primary mb-md-1">Hakkımızda</h6>
                                ...
                                <a href="https://demos.creative-tim.com/argon-design-system/docs/foundation/colors.html" class="media d-flex align-items-center">
                                    ...
                                    <div class="media-body ml-3">
                                        <h6 class="heading text-primary mb-md-1">Nasıl Çalışır ?</h6>
                                ...
                                <a href="https://demos.creative-tim.com/argon-design-system/docs/components/alerts.html" class="media d-flex align-items-center">
                                    ...
                                    <div class="media-body ml-3">
                                        <h5 class="heading text-warning mb-md-1">Burayada bir şeyler</h5>
                ...
                <ul class="navbar-nav align-items-lg-center ml-5">
                    <li class="nav-item">
                        <a class="nav-link nav-link-icon" href="#" target="_blank" title="Like us on Facebook">
                            <i class="fab fa-facebook-square"></i>
                            <span class="nav-link-inner--text d-lg-none">Facebook</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-icon" href="#" target="_blank" title="Follow us on Instagram">
                            <i class="fab fa-instagram"></i>
                            <span class="nav-link-inner--text d-lg-none">Instagram</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-icon" href="#" target="_blank" title="Follow us on Twitter">
                    ...
                    <li class="nav-item nav-link-icon d-lg-block">
                        <a href="/organization/login" class="btn btn-success btn-icon mb-3 mb-sm-0">
                            <span class="btn-inner--icon"><i class="fas fa-arrow-right"></i></span>
                            <span class="btn-inner--text"><spring:message code="organizationLogin"></spring:message> </span>
                        </a>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="col-12 col-md-12">
                            ...
                            <div class="card bg-gradient-lighter">
                                <div class="card-body text-center">
                                    ...
                                    <h4><spring:message code="multiAccountError"></spring:message> </h4>
                                    <h5><spring:message code="multiAccountLogout"></spring:message></h5>

                                    <a href="/logout" class="btn btn-default btn-sm float-right">
